...
<div className="flex min-h-screen">
  <aside className="w-64 bg-base-200 p-4">{/* Nav */}</aside>
...
<div className="card bg-base-100 shadow-xl ring-1 ring-base-content/5">...</div>
...
<div className="card bg-base-100 shadow-xl border-l-4 border-primary">...</div>
