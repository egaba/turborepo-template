...
const FEATURES = [
  {
    ...
    heading: 'Stupid Fast',
    description:
      'Snappy enough to make your old site feel like dialup. We obsess over milliseconds so you can obsess over aesthetics.',
  },
  {
    icon: <CodeIcon />,
    heading: 'Actually Typesafe',
    description:
      'No more "undefined is not a function" at 2am. Catch the dumb mistakes before your users do.',
  },
  {
    icon: <PaletteIcon />,
    heading: 'Dark Mode Native',
    description:
      'Themes that switch smoother than a barista pulling a single-origin pour-over. Your eyeballs will thank you.',
  },
  {
    icon: <RocketIcon />,
    heading: 'Ship It Yesterday',
    description:
      'Go from vibes to production before your cortado gets cold. No boilerplate rituals required.',
  },
  {
    icon: <ShieldIcon />,
    heading: 'Battle Tested',
    description:
      "We broke things so you don't have to. Every edge case has been lovingly argued about in a pull request.",
  },
  {
    icon: <GlobeIcon />,
    heading: 'Runs Everywhere',
    description:
      "Deploy to the cloud, a raspberry pi, or that ThinkPad you found at a flea market. We don't judge.",
  },
] as const
